...
def _compile_bwd_postprocess(
    ...
    mCuSeqlensQ = fake_tensor(Int32, (batchp1,), divisibility=1) if has_cuseqlens_q else None
    mSeqUsedQ = fake_tensor(Int32, (batch,), divisibility=1) if has_seqused_q else None
    mLearnableSink = fake_tensor(dtype, (mQ.shape[-2],), divisibility=1) if has_learnable_sink else None
    mdSink = fake_tensor(dtype, (mQ.shape[-2],), divisibility=1) if has_learnable_sink else None
...
class FlashAttnFunc(torch.autograd.Function):
    ...
    def backward(ctx, dout, dlse):
        ...
        if qv is not None:
            ...
            return dq, dk, dv, None, None, None, None, None, dsink, *((None,) * 30)
    ...
    def backward(ctx, dout, dlse):
        ...
        if qv is not None:
            ...
            if learnable_sink is None:
                ...
                dq, dk, dv, dsink = bwd_result
            return dq, dk, dv, None, *((None,) * 12), dsink, *((None,) * 31)
