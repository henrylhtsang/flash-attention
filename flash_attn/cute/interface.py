...
def _create_tma_paged_descriptor(
    ...
    For col_tiles > 1 (head_dim * elem_size > 128), uses atom-sized box (64, 8).
    """
    dtype_map = {
    ...
    err, desc = cuda.cuTensorMapEncodeTiled(
        ...
        (cuda.cuuint32_t(box_dim0), cuda.cuuint32_t(page_size if box_dim0 == head_dim else 8)),
